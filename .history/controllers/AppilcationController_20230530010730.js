...
const downloadDegreedocs = async (req, res) => {
  try {
   ...
   console.log(req.params.degree_reg_no);
    ...
    const degreeImagesPath = path.join(__dirname, `../public/degreeImages/${req.params.degree_reg_no}`);
    const degreePdfsPath = path.join(__dirname, `../public/degreePdfs/${req.params.degree_reg_no}`);
